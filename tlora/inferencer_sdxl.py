...
class LoraInferencerSDXL:
    ...
    def setup_model(self):
        ...
        # Get LoRA attention processor and linear layer classes, check lora.py for details
    ...
    def generate_with_prompt(self, prompt, num_images_per_prompt, batch_size):
        ...
        for i in range(n_batches):
            ...
            # generate images with loaded pipeline from model, in batches
    ...
    def generate_with_prompt_list(self, prompts, num_images_per_prompt, batch_size):
        for prompt in tqdm(prompts): # tqdm for progress bar, does nothing
            # re-format prompt in the {}-style to get output folder name
